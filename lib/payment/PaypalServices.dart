...
class PaypalServices {
  ...
  String domain = AppConfig.paypalSandboxMode? "https://api-m.sandbox.paypal.com" : "https://api-m.paypal.com";
  ...
  Future<String> getAccessToken() async {
    try {
      ...
      final uri = Uri.parse(domain + '/v1/oauth2/token?grant_type=client_credentials');

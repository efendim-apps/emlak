              ...
              Column(
                ...
                children: [
                  ListTile(
                    ...
                    title: Text(langPack['Featured'] + "   " +  AppConfig.featuredFee.toString()),
                    onTap: () {
                      setState(() {
                  ...
                  ListTile(
                    ...
                    title: Text(
                      langPack['Urgent'] + "   " +  AppConfig.urgentFee.toString(),
                      textDirection: CurrentUser.textDirection,
                    ),
                    onTap: () {
                      setState(() {
                  ...
                  ListTile(
                    ...
                    title: Text(
                      langPack['Highlighted'] + "   " +  AppConfig.highlightFee.toString(),
                      textDirection: CurrentUser.textDirection,
                    ),
                    onTap: () {
                      setState(() {

...
class AppConfig {
  ...
  static Future initialize() async {
    ...
    paypalSandboxMode = paymentInfo['paypal_sandbox_mode'] == 'Yes' ? true : false;
    ...
    payUMoneySandboxMode = paymentInfo['payumoney_sandbox_mode'] == 'test' ? true : false;
    ...
    payStackOn = decodedData['payment_method']['paystack'] == '1' ? true : false;
    payUMoneyOn = decodedData['payment_method']['payumoney'] == '1' ? true : false;
    razorpayOn = decodedData['payment_method']['razorpay'] == '1' ? true : false;
    flutterwaveOn = decodedData['payment_method']['flutterwave'] == '1' ? true : false;
    ...
    flutterwaveStagingMode = paymentInfo['flutterwave_staging_mode'] == 'Yes' ? true : false;

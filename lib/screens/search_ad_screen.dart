      ...
      appBar: PreferredSize(
        ...
        child: SafeArea(
          child: AppBar(
                                ...
                                child: Consumer<CurrentUser>(
                                    ...
                                    builder: (ctx, data, child) {
                                      ...
                                      if (CurrentUser.location.name != null ||
                                        ...
                                        return Text(
                                            '${CurrentUser.location.name}', style: TextStyle(color: Colors.blue, fontSize: 16, fontWeight: FontWeight.bold));
                                      }
            ...
            //title: Text('Home Tab'),
            backgroundColor: Colors.white,// HexColor(),
            elevation: 2,
          ),
        ),
      ),
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          if (foundProducts.isNotEmpty) {
                            return ProductItem(
                              isHighlighted: foundProducts[i * productLimit + index]
                              ['highlight'] == '1'
                                  ? true
                                  : false,
                            ...
                            default:
                              ...
                              if (snapshot.data.length > 0) {
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (ctx, index) {
                                    return ProductItem(
                                      isHighlighted: snapshot.data[i * productLimit + index]['highlight']
                                          == '1'
                                          ? true
                                          : false,

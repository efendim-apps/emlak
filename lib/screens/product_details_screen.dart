          ...
          Padding(
            ...
            child: FutureBuilder(
              future: DBHelper.queryFavProduct(
                  DBHelper.favTableName, pushedMap['productId']),
              builder: (ctx, snapshot) {
                ...
                return IconButton(
                  icon: Icon(
                      ...
                      color: Colors.grey[800]
                    // isFavorite ? Colors.wh : Colors.white,
                  ),
                  onPressed: () async {
                    if (!isFavorite) {
        ...
        children: [
          Container(
            ...
            child:  Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                IconButton(icon: Icon(Icons.chat_bubble_outline, color: Colors.white,),
                  onPressed: () {
          ...
          Container(
            ...
            child: Row(
              children: [
                IconButton(icon: Icon(Icons.contact_page, color: Colors.white,),
                  onPressed: () async {
                      ...
                      if(data != null) {
                        Navigator.of(context).pushNamed(
                            ...
                            arguments: {
                              ...
                              'seller_image':
                              'https://emlak.efendim.biz/storage/profile/' +
                                  data.data['seller_image'],
                              'seller_createdat':
                              data.data['seller_createdat'],
                            });
                      }
                    },
                            ...
                            ListTile(
                              ...
                              leading: CircleAvatar(
                                ...
                                foregroundImage: NetworkImage(
                                    'emlak.efendim.biz/storage/profile/' +
                                        snapshot.data['seller_image']),
                              ),
                              title: Text(
                                snapshot.data['seller_name'],

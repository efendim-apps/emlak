...
class _AuthScreenState extends State<AuthScreen> {
  ...
  // bool _isLogin = false;
  String _userEmail = 'mustafa.el.code@gmail.com';
  String _userName = '';
  String _name = '';
  String _userPassword = 'mustafa';
  ...
  void _submitAuthForm(
    ...
    try {
      ...
      if (isLogin) {
        ...
        // log("email.contains('@'): ${email.contains('@')}");
        // log("email: $email");
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
             // Image.asset("assets/images/logoClick4Sale.png", height: maxHeight * 0.15,),
              Container(
                child: Text(
                   "${langPack['Welcome']}," ,
                ...
                child: Column(
                  children: [
                    if (!_isLogin)
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          suffixIcon: Icon(Icons.account_circle_rounded,  size: 20,),
                    ...
                    TextFormField(
                      ...
                      textDirection: CurrentUser.textDirection,
                      decoration: InputDecoration(
                        suffixIcon: Icon(Icons.lock_rounded,  size: 20,),
                   ...
                   Row(
                     ...
                     crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                       (AppConfig.disableAdSocial ?? false)?InkWell(
                         onTap: () async {
                       ...
                       SizedBox(width: 20,),
                       (AppConfig.disableFbSocial ?? false)?InkWell(
                         onTap: () async {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Text(
                            _isLogin ? langPack['Sign In'] : langPack['LOG IN'],
                            textDirection: CurrentUser.textDirection,
                            style: TextStyle(
                                color: HexColor(),
                                fontWeight: FontWeight.bold,
